...
class ControlSuiteShell(cmd.Cmd):
    ...
    def __init__(self):
        ...
        rospy.init_node('phri_simulation_mobile_controlsuite')        
        
        self.ctrl_type = 0
        self.ctrl_type_pub = rospy.Publisher('/ns1/mujoco_ros/mujoco_ros_interface/ctrl_type', Int16, queue_size=1)
